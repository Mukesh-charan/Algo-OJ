      ...
      <div>
        ...
        <div className="container">
          ...
          <div style={{ display: "flex", gap: "100px", width: "100%" }}>
            <button style={{ flex: 1, backgroundColor: "black" }} onClick={() => navigate("/problemDashboard")}><h2 style={{ color: "white"}}>Problem Management</h2></button>
            <button style={{ flex: 1, backgroundColor: "black" }} onClick={() => navigate("/userDashboard")}><h2 style={{ color: "white"}}>User Management</h2></button>
          </div>
          <div style={{ display: "flex", gap: "100px", width: "100%", marginTop: "20px" }}>
            <button style={{ flex: 1, backgroundColor: "black" }} onClick={() => navigate("/contest")}><h2 style={{ color: "white" }}>Contest Management</h2></button>
            <button onClick={toggleAiStatus} style={{flex:1, backgroundColor: "black"}}><h2 style={{ color: "white" }}>
              {aiEnabled ? "Disable AI" : "Enable AI"}</h2>
            </button>
          </div>
          <div style={{ display: "flex", gap: "100px", width: "100%", marginTop: "20px" }}>
            <button style={{ flex: 1, backgroundColor: "black" }} onClick={() => navigate("/")}><h2 style={{ color: "white" }}>Console</h2></button>
          </div>
        </div>
      </div>
    </div>
