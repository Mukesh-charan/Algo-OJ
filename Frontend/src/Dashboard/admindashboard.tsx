      ...
      <div>
        ...
        <div className="container">
          ...
          <div style={{ display: "flex", gap: "100px", width: "100%" }}>
            <button style={{ flex: 1 }} onClick={() => navigate("/problemDashboard")}><h2 style={{ color: "white",background-color: "black" }}>Problem Management</h2></button>
            <button style={{ flex: 1 }} onClick={() => navigate("/userDashboard")}><h2 style={{ color: "white", background-color: "black" }}>User Management</h2></button>
          </div>
