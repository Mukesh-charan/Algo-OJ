...
export const createContest = async (req, res) => {
    const { name, startDate, startTime, endDate, endTime, problems} = req.body;  // <-- get problems array here

    try {
        const newContest = new Contest({ name, startDate, startTime, endDate, endTime, problems });  // save problems properly
